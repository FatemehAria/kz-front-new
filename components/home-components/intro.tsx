  ...
  return (
    <div className="grid md:grid-cols-2 grid-cols-1 text-right relative">
      ...
      <div className="flex flex-col justify-center items-end gap-5">
        ...
        <p className="text-[#939393] md:max-w-[25rem] text-[16px]">
          شرکت بین ااملی کیکاووس زمان با تکیه بر دانش فنی وتخصصی بابهترین روش
          هااز متخصصان برای توسعه ی نرم افزار های نوآورانه استفاده می کند وبه
          ارائه خدمات با کیفیت در زمینه های برنامه نویسی، بازرگانی وتولید قطعات
          کامپیوترمطابق با استانداردهای بین الملی می پردازد
        </p>
        <IntroBtns />
      </div>
    </div>
