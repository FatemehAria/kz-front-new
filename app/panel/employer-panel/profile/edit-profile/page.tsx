"useclient";
"use client";
import InfoFields from "@/app/panel/components/info-fields";
  ...
  return (
    <div className="w-[90%] mx-auto rounded-xl p-[2%] grid grid-cols-1 justify-center gap-[3%] lg:bg-profileBorderbg my-[2%]">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-[25%] lg:flex lg:gap-0">
          <button
            className="bg-[#EDF0FB] text-black flex justify-center items-center rounded-lg py-[1%] px-[5%] mx-auto lg:w-[8%] w-full"
            type="submit"
          >
            تایید
          </button>
